...
public class IngredientController {
    ...
    public void getIngredients(Context ctx) {
       ...
       if(page != null && pageSize != null) {
        Page<Ingredient> ingredientPage = ingredientService.searchIngredients(term, page, pageSize, sortBy, sortDirection);
        ctx.status(200).json(ingredientPage);
       }
       else {
        List<Ingredient> ingredients = ingredientService.searchIngredients(term);
